...
return { moveCard, tapForMana, toggleTap, toggleAttack, addCounter, createToken, copyAsToken, adjustPlayer, adjustCommanderDamage, adjustMana, clearMana, draw, mill, shuffleLibrary, nextPhase, setPhase, switchActivePlayer, resolveStackTop, counterStackTop, mulligan, concede, updateCardNote, flipCard, revealTop, revealTopPublicly, revealCardPublicly, assignBlocker, attachCard };
})();
...
const { addCounter, assignBlocker, attachCard, adjustCommanderDamage, adjustMana, adjustPlayer, clearMana, copyAsToken, counterStackTop, createToken, draw, flipCard, mill, moveCard, mulligan, concede, nextPhase, resolveStackTop, revealCardPublicly, revealTopPublicly, setPhase, shuffleLibrary, switchActivePlayer, toggleAttack, toggleTap, tapForMana, updateCardNote } = __modules["./game.js"];
