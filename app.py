...
.card-action-panel {padding:12px;border-radius:12px;}
</style>
</style>
    <div class="hero">
...
st.divider()
tabs = st.tabs(["⚔️ Playmat", "🛠 Card Actions", "✨ Effects", "🏰 Commander", "📚 Library", "❔ Help"])

with tabs[0]:
    st.info("Tip: Use the Playmat view for your main game. Select cards from Card Actions when you need to move or modify them.")
    for player_index, player in enumerate(game.players):
