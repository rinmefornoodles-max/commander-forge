(() => {
  ...
  function safeTechnicalSnapshot() {
    ...
    return {
      ...
      gameplayBuild: window.CommanderForgeBuildVersion || '6.13.0',
  ...
  function installFeedbackDiagnostics() {
    ...
    if (!form || form.dataset.diagnostics614 === '1') return;
    form.dataset.diagnostics614 = '1';
  ...
  function installRuntimeReporter() {
    ...
    if (!root || root.dataset.diagnostics614 === '1') return;
    root.dataset.diagnostics614 = '1';
