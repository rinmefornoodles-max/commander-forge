...
function compactScryfallCard(raw) {
  ...
  return {
    ...
    layout: raw.layout,
    image: raw.image_uris?.normal || face?.image_uris?.normal || './assets/card-back.svg',
    imageSmall: raw.image_uris?.small || face?.image_uris?.small || raw.image_uris?.normal || './assets/card-back.svg',
