...
const MULTIPLAYER_APP_VERSION = '5.16.0';
const multiplayer = {
  mode: 'solo',
  role: null,
  localPlayerId: null,
...
function multiplayerActionAllowed(button, action) {
  ...
  const localId = multiplayer.localPlayerId;
  const safeActions = new Set(['coach', 'run-coach', 'close-inspector', 'open-log', 'close-log', 'open-settings', 'close-settings', 'open-setup', 'close-setup', 'open-zone', 'close-drawer', 'open-damage', 'close-damage', 'export-save', 'close-public-reveal', 'close-scry']);
